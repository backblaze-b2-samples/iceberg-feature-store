...
| `humanizeBytes` duplicated in TypeScript | DRY violation | Centralized in `apps/web/src/lib/utils.ts` | Low | Resolved |
| `formatDate` duplicated in TypeScript | DRY violation | Centralized in `apps/web/src/lib/utils.ts` | Low | Resolved |
