...
> The SQLite Iceberg catalog pointer (`services/api/data/catalog.db`) needs a persistent volume for durability across restarts — attach a Railway volume mounted at `services/api/data`, or switch to a server-backed catalog.
